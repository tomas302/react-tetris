const Tetromino = {
    ...
    /*
        This dictionary defines the shape of each type of Tetromino taking as relative center the rotation center defined by the official Super Rotation System(https://tetris.fandom.com/wiki/SRS).
    ...
    */
    ...
    getRandomTetromino: () => {
        return {
            type: Tetromino.types[Math.floor(Math.random() * 7)],

        };
    },
    getProperties: (type) => {
        return {
            color: Tetromino.color[type],
            shape: Tetromino.shape[type]
        };
    }
};
